<%@ Page Title="" Language="C#" MasterPageFile="~/Likey.Master" AutoEventWireup="true" CodeBehind="forum_post.aspx.cs" Inherits="EADProj.forum_page" EnableEventValidation="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <h1 style="font-size: 65%"> <asp:Label ID="LabelPostHeader" runat="server" Text=""></asp:Label> </h1>
 ...
 <div id="forum-tags">
            ...
            <asp:LinkButton ID="LinkButtonDelete" runat="server" Font-Size="Small" OnClick="LinkButtonDelete_Click1">Delete</asp:LinkButton>
                    ...
                    <td>
                        <div class="forum-post-subinstance">
                            ...
                            <div style="display: flex">
                                ...
                                <img style="width: 100%" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQE_0p3sdt4wuD5X2ZnKrT5pOCmDJ1N73Y5lfSJNU1f_W-hpQ41" />
            ...
            <FooterTemplate>
               ...
               <div class="forum-post-container" style="margin-bottom: 5vh; margin-top: 7px">
                   <div style="display: inline-block;">
                       <asp:Image ID="ImageUser" runat="server" CssClass="forum-user-image" />
