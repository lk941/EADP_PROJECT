<%@ Page Title="" Language="C#" MasterPageFile="~/menu.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="eadp_forum.login" %>
        ...
        <div class='login'>
            <h2>Login</h2>
                ...
                <div class='agree'>
                    ...
                    <label style="display: block;margin-top: 1em;margin-left: 6.5em;"><a href="https://localhost:44300/register.aspx">Don't have an account?</a></label>
