...
namespace eadp_forum.DLL
{
    public class UserDAO
    {
        ...
        public void Insert(User user)
        {
            ...
            string sqlStmtInsert = "INSERT INTO [User] (username, password, email) VALUES (@paraUsername, @paraPassword, @paraEmail)";
            SqlCommand sqlCmd = new SqlCommand(sqlStmtInsert, myConn);

            sqlCmd.Parameters.AddWithValue("@paraUsername", user.name);
