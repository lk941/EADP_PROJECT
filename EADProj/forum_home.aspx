<%@ Page Title="" Language="C#" MasterPageFile="~/Likey.Master" AutoEventWireup="true" CodeBehind="forum_home.aspx.cs" Inherits="EADProj.forum_home" %>
...
<script>
 ...
 <div class="forum_tags" style="font-size: 110%; border-color: white; display: inline-block;
   
    letter-spacing: 2px;
    font-size: 0.9vh;
    color: white;" runat="server">
                        <p> ART</p> <p> MATHS</p> <p>CHEMISTRY</p> <P>IT</P>
     <p>PHYSICS</p>
                    </div>
                </div>
